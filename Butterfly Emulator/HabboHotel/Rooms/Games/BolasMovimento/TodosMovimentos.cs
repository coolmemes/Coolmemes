...
namespace Butterfly.HabboHotel.Rooms.Games.BolasMovimento
{
    ...
    class Rebug : IMovimentos
    {
        ...
        public ComeDirection GetComeDirection(int Rot, bool FromBehind = false, bool FromLeft = false, bool FromRight = false, bool FromUpLeftSide = false, bool FromUpRightSide = false)
        {
            switch (Rot)
            {
                case 0:
                    ...
                    else if (FromUpLeftSide)
                        return ComeDirection.DOWN_LEFT;

                    else if (FromUpRightSide)
