...
{
    class NotFurniStatePosMatch : IWiredCondition
    {
        ...
        public NotFurniStatePosMatch(RoomItem item, List<RoomItem> items, string itemsState, Dictionary<uint, OriginalItemLocation> originalItemLocation)
        {
