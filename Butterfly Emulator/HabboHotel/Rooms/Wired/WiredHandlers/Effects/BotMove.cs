...
{
    class BotMove : IWiredTrigger, IWiredEffect, IWiredCycleable
    {
        ...
        public BotMove(UInt32 itemID, Room room, WiredHandler handler, String botname, List<RoomItem> items, UInt32 time)
        {
            this.itemID = itemID;
            this.room = room;
