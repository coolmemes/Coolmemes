        ...
        private void setHeuristictype(AStarHeuristicType calculator)
        {
            switch (calculator)
            {
                case AStarHeuristicType.FAST_SEARCH:
                    CalculationMethod = CalculateHeuristicFast;
                    break;
                case AStarHeuristicType.BETWEEN:
                    CalculationMethod = CalculateHeuristicBetween;
                    break;
                case AStarHeuristicType.SHORTEST_PATH:
                    CalculationMethod = CalculateHeuristicShortestRoute;
                    break;
                case AStarHeuristicType.EXPERIMENTAL_SEARCH:
                    CalculationMethod = CalculateHeuristicExperimental;
                    break;
            }
        }
